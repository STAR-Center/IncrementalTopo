...
from im2skeleton import point_gaussian, edgeprocess, binarize
...
#        plt_2link[:,1] -= upper_left[1] 
    ...
    def extract_and_thin(self):
        ...
        #4. suppress
        skeleton = thin(canvas) 
        self.topo_map[self.local_canvas_mask]  = skeleton[self.local_canvas_mask] 
        #reset the local mask
